...
const APP_SETTINGS = {
    "@Default": "P.Liebl",
    "DefaultPage" : "Info",              // Page to be loaded on initialization

    /**
     * "app":
     * 
     * Settings for the application.
     * all properties become available as vars for substitutions in html and i18n files.
    ...
    "app": {
        ...
        "latest": {
            "url": "https://api.github.com/repos/LSC-Labs/DewPoint-Switch/releases/latest"
        },
    ...
    /**
     * Default menu structure (basic)
     * - First a status element,
     * - Second a submenu with "Settings" for this device (used by PLibESP* pages)
     * - Third a submenu with "Maintenance" for this device (used by PLibESP* pages)
     * 
     */
    "menu":        [
        { 
        ...
        },
        {
            ...
            "icon": "Maintenance",
            /*
                set the data-auth, if authorization is needed - see documentation.
